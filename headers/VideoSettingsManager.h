...
public:
    ...
    void RegisterListener(std::string sourceKey, std::function<void(const std::string, const std::string&)> callback);
...
private:
    ...
    std::unordered_map<std::string, std::function<void(const std::string, const std::string&)>> m_listenersMap;
